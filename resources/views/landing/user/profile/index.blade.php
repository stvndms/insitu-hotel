...
<body class="font-poppins bg-body">
                ...
                <div class="pt-[110px]">
                    <div class="bg-white p-3 gap-3 rounded-lg items-center pt-5 mb-10 lg:h-[650px] lg:pt-10 lg:p-10">
                        <div class="grid grid-cols-3 items-center lg:px-[80px] lg:mt-8">
                                <div class="mx-auto">
                                    <img class="rounded-full w-[60px] lg:w-[100px]" src="assets/image/chae.jpg" alt="">
                                </div>
                                <div class="text-[10px] lg:text-lg text-center">
                                    <span class="font-semibold">Son Chaeyoung</span>
                                    <div><span class="text-slate-500 text-[8px] lg:text-[13px]">chae@gmail.com</span></div>
                                </div>
                                <div class="mx-auto">
    ...
    <!-- Footer Start -->
    <footer class="lg:absolute lg:bottom-0 lg:right-0 lg:left-0">
