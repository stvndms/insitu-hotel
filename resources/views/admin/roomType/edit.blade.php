                ...
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <div class="flex-auto p-6">
                        <form role="form" action="{{ route('room-type.update', $roomType->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <input type="text" class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-orange focus:transition-shadow" placeholder="Room Type" name="room_type" value="{{ $roomType->room_type }}"/>
                            </div>
